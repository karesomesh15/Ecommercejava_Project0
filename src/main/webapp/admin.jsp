    ...
    <div class="container-fluid py-4 px-3">
        ...
        <div class="row">
            <div class="container text-center" id="details">
                <i class="bi bi-person-workspace" style="font-size: 6rem; color: #2874f0;"></i>
                    ...
                    <a href="display_category.jsp">
                        <div class="card text-bg-light mb-3 text-center">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mt-3">All Categories</h4>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="display_products.jsp">
                        <div class="card text-bg-light mb-3 text-center">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mt-3">All Products</h4>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="DisplayOrdersServlet">
                        <div class="card text-bg-light mb-3 text-center">
                            <div class="card-body">
